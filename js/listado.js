...
Listado.prototype.buscarRestaurante = function(id) {
    ...
    var encontrado = this.restaurantes.find(function(restaurante){
...
Listado.prototype.obtenerCiudades = function() {
    ...
    var listaCiudades = limpiarRepeticiones(ciudades);

    return listaCiudades;
}

function limpiarRepeticiones(lista){

    var listaLimpia = lista.filter(function(elem, index, self) {
        return index === self.indexOf(elem);
    });
    
    return listaLimpia.sort();
}
...
Listado.prototype.obtenerRubros = function() {
    ...
    var listaRubros = limpiarRepeticiones(rubros);
...
Listado.prototype.obtenerHorarios = function() {
    ...
    horarios.forEach(function(unHorario) {
        unHorario.forEach(function(hora) {
            todosLosHorarios.push(hora)
        });
    });

    //En este arreglo vamos a poner todos los horarios pero sin repetidos
    var listaHorarios = limpiarRepeticiones(todosLosHorarios);
